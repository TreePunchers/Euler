...
for r in range(len(grid)):
    for c in range(len(grid[r])):
        down = prod_down_4(r, c)
        across = prod_across_4(r, c)
        diag_right = prod_diag_right_4(r, c)
        diag_left = prod_diag_left_4(r, c)
        if down > answer:
            answer = down
        if across > answer:
            answer = across
        if diag_right > answer:
            answer = diag_right
        if diag_left > answer:
            answer = diag_left
